...
public class Principal {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        List<Musica> musicasDoAutor1 = autor_dao.buscarTodosPorAutor(autor1);
        List<Musica> musicasDoAutor2 = autor_dao.buscarTodosPorAutor(autor2);
        List<Musica> musicasDoAutor3 = autor_dao.buscarTodosPorAutor(autor3);
